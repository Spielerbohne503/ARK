...
const CANDIDATES = {
  ...
  archaeopteryx: ['Dossier Archaeopteryx.png'],
  chalicotherium: ['Dossier Chalicotherium.png'],
  dimetrodon: ['Dossier Dimetrodon.png'],
  diplocaulus: ['Dossier Diplocaulus.png'],
  dungbeetle: ['Dossier Dung Beetle.png'],
  electrophorus: ['Dossier Electrophorus.png'],
  featherlight: ['Dossier Featherlight.png'],
  fenrir: ['Mod Fjordur Fenrir.png'],
  giantbee: ['Dossier Giant Bee.png'],
  gigantopithecus: ['Dossier Gigantopithecus.png'],
  glowtail: ['Dossier Glowtail.png'],
  hesperornis: ['Dossier Hesperornis.png'],
  kairuku: ['Dossier Kairuku.png'],
  liopleurodon: ['Dossier Liopleurodon.png'],
  megalosaurus: ['Dossier Megalosaurus.png'],
  microraptor: ['Dossier Microraptor.png'],
  onyc: ['Dossier Onyc.png'],
  ovis: ['Dossier Ovis.png'],
  pachyrhinosaurus: ['Dossier Pachyrhinosaurus.png'],
  pegomastax: ['Dossier Pegomastax.png'],
  phoenix: ['Dossier Phoenix.png'],
  shinehorn: ['Dossier Shinehorn.png'],
  titanosaur: ['Dossier Titanosaur.png'],
  troodon: ['Dossier Troodon.png'],
  unicorn: ['Unicorn.png'],
  voidwyrm: ['Voidwyrm.png'],
  carcha: ['Carcharodontosaurus.png'],
  rhyniognatha: ['Rhyniognatha .png', 'Rhyniognatha.webp'],
  direpolarbear: ['Dire Polar Bear.png'],
  mek: ['Dossier Mek.png'],
  exomek: ['Exo-Mek.png'],
  scout: ['Dossier Scout.png'],
};
