...
const WILD = {
  ...
  corruptedraptor: 'Corrupted Raptor.png',
  corruptedcarno: 'Corrupted Carnotaurus.png',
  corrupteddilo: 'Corrupted Dilophosaur.png',
  corrupteddimorph: 'Corrupted Dimorphodon.png',
  corruptedptera: 'Corrupted Pteranodon.png',
  corruptedstego: 'Corrupted Stegosaurus.png',
  corruptedtrike: 'Corrupted Triceratops.png',
  corruptedchalico: 'Corrupted Chalicotherium.png',
  corruptedparacer: 'Corrupted Paraceratherium.png',
  corruptedrockdrake: 'Corrupted Rock Drake.png',
  alphafirewyvern: 'Alpha Fire Wyvern.png',
  alphabloodcrystalwyvern: 'Alpha Blood Crystal Wyvern.png',
  alphaxtrike: 'Alpha X-Triceratops.png',
  alphaleedsichthys: 'Alpha Leedsichthys.png',
  rubblegolem: 'Rubble Golem.png',
  summoner: 'Summoner.png',
  spiritdirewolf: 'Spirit Direwolf.png',
