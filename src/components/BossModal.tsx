  ...
  return (
    ...
    >
      <div
        ...
        className="flex max-h-[92vh] w-full max-w-xl animate-slide-up flex-col overflow-hidden rounded-2xl border border-gray-700 bg-ark-surface shadow-2xl shadow-black/60 sm:animate-modal-in"
      >
        {/* Kopf mit Boss-Bild */}
