...
export const BOSSES: Boss[] = [
  ...
  {
    id: 'fjordur_broodmother',
    name: 'Broodmother Lysrix (Fjordur)',
    map: 'Fjordur',
    arena: 'Broodmother-Arena',
    difficulties: GBA,
    access: 'Beschwörung am grünen Obelisken (Midgard)',
    tribute: ['Artifact of the Clever', 'Artifact of the Hunter', 'Artifact of the Massive', 'diverse Trophäen'],
    recommended: 'Megatherium mit Insekten-Buff oder gezüchtete Rexe; Netze und Gift wie auf The Island',
    description: 'Die Spinnenkönigin lässt sich auch auf Fjordur herausfordern – gleiche Arena-Mechanik, eigener Sieg-Eintrag für den 100%-Durchlauf.',
    imageUrl: img('broodmother'),
  },
  {
    id: 'fjordur_megapithecus',
    name: 'Megapithecus (Fjordur)',
    map: 'Fjordur',
    arena: 'Megapithecus-Arena',
    difficulties: GBA,
    access: 'Beschwörung am blauen Obelisken (Vannaland)',
    tribute: ['Artifact of the Brute', 'Artifact of the Devourer', 'Artifact of the Pack', 'diverse Trophäen'],
    recommended: 'Rex-Armee mit Rüstungssätteln; Abstand zur Plattform-Kante halten',
    description: 'Der Riesenaffe als Fjordur-Variante der klassischen Arena – Tribut über die Höhlen-Artefakte der Map.',
    imageUrl: img('megapithecus'),
  },
  {
    id: 'fjordur_dragon',
    ...
    arena: 'Dragon-Arena',
    difficulties: GBA,
    access: 'Beschwörung am roten Obelisken (Balheimr)',
    tribute: ['Artifact of the Cunning', 'Artifact of the Immune', 'Artifact of the Skylord', 'Artifact of the Strong', 'diverse Trophäen'],
    recommended: 'Deinonychus mit Blutungs-Stacks; der prozentuale Feueratem bestraft reine HP-Armeen',
    description: 'Auch der Drache wartet auf Fjordur – der härteste der drei klassischen Bosse, Pflicht für jeden 100%-Durchlauf der Map.',
    imageUrl: img('dragon'),
  },
  {
    id: 'beyla',
